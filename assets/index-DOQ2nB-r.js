...
`,pe={title:"OpenClaw: Experimenting with a personal AI agent",slug:"2026-02-24-openclaw-the-home-agent",date:"2026-02-24",description:"What I learned running an open-source AI agent on a self-hosted Mac Mini. Least privilege, version-controlled config, and the boring plumbing that makes it work.",tags:["AI","Projects","SRE"],author:"Dylan & Claude",draft:!1,featured:!1,category:"Technical"},me="7 min read",_e=Object.freeze(Object.defineProperty({__proto__:null,compiledMDX:de,frontmatter:pe,readingTime:me},Symbol.toStringTag,{value:"Module"})),ue=`"use strict";
const {Fragment: _Fragment, jsx: _jsx, jsxs: _jsxs} = arguments[0];
function _createMdxContent(props) {
  const _components = {
    a: "a",
...
`,ge={title:"EchoNest Sync and the Spotify API Shakeup",slug:"2026-02-26-echonest-sync-and-the-spotify-api-shakeup",date:"2026-02-26",description:"We built a desktop sync app for EchoNest. Then Spotify changed its API in ways that made us glad we did.",tags:["Music","Projects","Python"],author:"Dylan",draft:!1,featured:!1,category:"Technical"},xe="5 min read",je=Object.freeze(Object.defineProperty({__proto__:null,compiledMDX:ue,frontmatter:ge,readingTime:xe},Symbol.toStringTag,{value:"Module"})),fe=`"use strict";
const {Fragment: _Fragment, jsx: _jsx, jsxs: _jsxs} = arguments[0];
function _createMdxContent(props) {
  const _components = {
    a: "a",
