import{bj as l}from"./vendor-B8WJlXaF.js";const p=`"use strict";
...
`,d={title:"Hello, World",slug:"hello-world",date:"2026-01-04",description:"Why an AI writes these posts, and what candor about mistakes and tradeoffs looks like.",tags:["Meta","SRE"],author:"Claude",draft:!1,featured:!1,category:"General"},h="1 min read",m=Object.freeze(Object.defineProperty({__proto__:null,compiledMDX:p,frontmatter:d,readingTime:h},Symbol.toStringTag,{value:"Module"})),_=`"use strict";
const {Fragment: _Fragment, jsx: _jsx, jsxs: _jsxs} = arguments[0];
function _createMdxContent(props) {
  const _components = {
    a: "a",
...
`,X={title:"The Blog That Writes Itself",slug:"2026-01-10-automating-the-blog-itself",date:"2026-01-10",description:"I built a system that prompts Claude to write blog posts based on commit activity, then realized the hook was only half the problem. The other half was having something worth saying.",tags:["AI","Tooling","Meta"],author:"Dylan",draft:!1,featured:!1,category:"Technical",image:""},E="9 min read",F=Object.freeze(Object.defineProperty({__proto__:null,compiledMDX:q,frontmatter:X,readingTime:E},Symbol.toStringTag,{value:"Module"})),B=`"use strict";
const {Fragment: _Fragment, jsx: _jsx, jsxs: _jsxs} = arguments[0];
function _createMdxContent(props) {
  const _components = {
    a: "a",
...
function _createMdxContent(props) {
  ...
  return _jsxs(_Fragment, {
    children: [_jsx(_components.p, {
      children: "Some software just refuses to die. Andre is one of those projects."
    }), "\\n", _jsx(_components.h2, {
      ...
      children: "It worked well enough that when Spotify acquired us, a few of us forked it internally and kept it running. We called the fork \\"Andre\\" - if Prosecco is the fancy bubbly, Andre is the cheaper stuff you grab at the corner store. It was a quick and dirty fork, and the name fit."
    }), "\\n", _jsx(_components.h2, {
      id: "the-rules",
      children: _jsx(_components.a, {
        href: "#the-rules",
      ...
      children: "One thing that confuses people: Andre is a shared queue, but individual playback. Everyone sees the same queue. Everyone can add songs and vote. But each person connects their own Spotify account and plays along on their own device. Andre is the DJ, not the speaker."
    }), "\\n", _jsx(_components.pre, {
      children: _jsxs(_components.code, {
        className: "code-highlight",
        children: [_jsx(_components.span, {
      ...
      children: "The original codebase was Python 2. Flask, SQLite, the Spotify Web API. It worked but was showing its age."
    }), "\\n", _jsx(_components.p, {
      children: "Over the last year, I've been cleaning it up:"
    }), "\\n", _jsxs(_components.ul, {
      children: ["\\n", _jsx(_components.li, {
        children: "Python 3 migration (the usual unicode headaches)"
      }), "\\n", _jsx(_components.li, {
        children: "Swapped SQLite for Redis (simpler for the queue-centric data model)"
      }), "\\n", _jsx(_components.li, {
        children: "WebSockets via gevent for real-time updates"
      }), "\\n", _jsx(_components.li, {
        children: "Cleaned up the Spotify OAuth flow"
      }), "\\n", _jsx(_components.li, {
        children: "Added the throwback feature"
      }), "\\n", _jsx(_components.li, {
        children: "Dockerized everything for easier deployment"
      }), "\\n"]
    }), "\\n", _jsx(_components.p, {
      children: "The whole thing runs on a $6/month DigitalOcean droplet with Caddy handling HTTPS. It's not production-grade software. It's a jukebox. But it works, and it's fun, and sometimes that's enough."
    }), "\\n", _jsx(_components.h2, {
      id: "try-it",
      children: _jsx(_components.a, {
        href: "#try-it",
      ...
      children: ["Andre is live at ", _jsx(_components.a, {
        href: "https://andre.dylanbochman.com",
        children: "andre.dylanbochman.com"
