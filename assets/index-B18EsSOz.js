...
`,B={title:"The Blog That Writes Itself",slug:"2026-01-10-automating-the-blog-itself",date:"2026-01-10",description:"I built a system that prompts Claude to write blog posts based on commit activity, then realized the hook was only half the problem. The other half was having something worth saying.",tags:["AI","Tooling","Meta"],author:"Dylan",draft:!1,featured:!1,category:"Technical",image:""},X="9 min read",E=Object.freeze(Object.defineProperty({__proto__:null,compiledMDX:q,frontmatter:B,readingTime:X},Symbol.toStringTag,{value:"Module"})),F=`"use strict";
const {Fragment: _Fragment, jsx: _jsx, jsxs: _jsxs} = arguments[0];
function _createMdxContent(props) {
  const _components = {
    a: "a",
...
`,jn={title:"Decap CMS with Netlify: Git Gateway, Build Hooks, and the Cloudflare Gotcha",slug:"2026-01-15-decap-cms-netlify-setup-guide",date:"2026-01-15",description:"Setting up Decap CMS with Netlify Identity, Git Gateway, and build hooks — config.yml included — plus the fix for the 405 error behind Cloudflare.",tags:["Web Dev"],author:"Claude",draft:!1,featured:!1,category:"Technical"},fn="5 min read",wn=Object.freeze(Object.defineProperty({__proto__:null,compiledMDX:xn,frontmatter:jn,readingTime:fn},Symbol.toStringTag,{value:"Module"})),yn=`"use strict";
const {Fragment: _Fragment, jsx: _jsx, jsxs: _jsxs} = arguments[0];
function _createMdxContent(props) {
  const _components = {
    a: "a",
...
`,Ce={title:"Two Supply Chain Attacks in One Day",slug:"2026-04-30-two-supply-chain-attacks-in-one-day",date:"2026-04-30",description:"Lightning on PyPI and intercom-client on npm got compromised the same morning by what looks like the same attacker. We weren't exposed, but the threat shape changed enough that I walked back a position I took a month ago.",tags:["Security"],author:"Dylan & Claude",draft:!1,featured:!1,category:"Technical"},Se="8 min read",Me=Object.freeze(Object.defineProperty({__proto__:null,compiledMDX:Ie,frontmatter:Ce,readingTime:Se},Symbol.toStringTag,{value:"Module"})),De=`"use strict";
const {Fragment: _Fragment, jsx: _jsx, jsxs: _jsxs} = arguments[0];
function _createMdxContent(props) {
  const _components = {
    a: "a",
