import{r as l,j as i,ah as p,ai as h}from"./vendor-7ZqEmp6V.js";import{C as u,a as m,b as g,d as f,e as b,i as v}from"./index-BAHkG5nY.js";import{T as w,a as y}from"./tabs-BihDn2rO.js";import{R as C}from"./responsive-tabs-BGDv8e-p.js";import{A as x}from"./AnimatedMermaidDiagram-DxTW29s4.js";import"./monitoring-C74x5Iy6.js";import"./ui-BQCqNqg0.js";import"./theme-AHbnqsHs.js";import"./select-CdHroir8.js";const r=[{id:"incident-escalation",title:"Incident Escalation Process",description:"Route incidents based on severity and decide when to involve additional on-call support.",code:`---
config:
  layout: fixed
---
flowchart TD
...
`,nodes:[{id:"A",label:"Issue identified in a specific service",description:"You've identified which service is causing the problem."},{id:"B",label:"Search service catalog for owner info",description:"Check your service catalog/registry for ownership info."},{id:"C",label:"Page On-Call",description:"Use the catalog link to page the service owner."},{id:"D",label:"Search on-call tool for service",description:"Search PagerDuty/OpsGenie directly for the service."},{id:"E",label:"Page On-Call",description:"Found it - page the service owner."},{id:"F",label:"Check Slack/Teams/Email",description:"Try communication channels to find the owner."},{id:"G",label:"Service Owner Found",type:"decision",branches:[["Found",7],["Not Found",8]],description:"Were you able to locate someone responsible?"},{id:"H",label:"Page On-Call",description:"Successfully located owner - page them."},{id:"J",label:"Escalate within your team",description:"No owner found - escalate to your leadership."}]}],P=r.map(t=>({value:t.id,label:t.title}));function k({title:t,description:s,code:a,nodes:d,onLinkClick:e}){const[n,o]=l.useState(!1),c=async()=>{await navigator.clipboard.writeText(a.trim()),o(!0),setTimeout(()=>o(!1),2e3)};return i.jsxs(u,{children:[i.jsxs(m,{children:[i.jsx(g,{as:"h2",className:"text-xl",children:t}),i.jsx(f,{children:s})]}),i.jsxs(b,{className:"space-y-4",children:[i.jsx(x,{code:a,nodes:d,speed:1500,onLinkClick:e}),i.jsxs("details",{className:"rounded-md border border-dashed px-4 py-3 text-sm",children:[i.jsx("summary",{className:"cursor-pointer text-muted-foreground",children:"View Mermaid source"}),i.jsxs("div",{className:"mt-3 space-y-3",children:[i.jsxs(v,{variant:"outline",size:"sm",onClick:c,className:"gap-2",children:[n?i.jsx(p,{className:"h-4 w-4"}):i.jsx(h,{className:"h-4 w-4"}),n?"Copied":"Copy Mermaid"]}),i.jsx("pre",{className:"whitespace-pre-wrap text-xs text-muted-foreground",children:a.trim()})]})]})]})]})}function M(){const[t,s]=l.useState(r[0].id);l.useEffect(()=>{const e=()=>{const n=window.location.hash.replace("#","");r.some(o=>o.id===n)&&s(n)};return e(),window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]);const a=e=>{s(e),typeof window<"u"&&window.history.replaceState(null,"",`#${e}`)},d=e=>{e.startsWith("/")?window.open(e,"_blank"):a(e)};return i.jsxs("div",{className:"space-y-6",children:[i.jsx("p",{className:"text-sm text-muted-foreground",children:"Three incident command flowcharts that you can reuse, edit, and export as Mermaid. Use the tabs to switch views and copy the underlying diagram code."}),i.jsxs(w,{value:t,onValueChange:a,className:"space-y-4",children:[i.jsx(C,{label:"Incident response diagram",items:P,value:t,onValueChange:a,tabsListClassName:"h-auto w-fit max-w-full flex-wrap justify-start gap-1 rounded-lg bg-zinc-200 p-1 text-muted-foreground dark:bg-zinc-800",triggerClassName:"rounded-md px-3 py-1.5 text-xs data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-xs sm:text-sm"}),r.map(e=>i.jsx(y,{value:e.id,id:e.id,children:i.jsx(k,{title:e.title,description:e.description,code:e.code,nodes:e.nodes,onLinkClick:d})},e.id))]})]})}export{M as default};
