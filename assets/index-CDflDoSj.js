import{j as i,bd as g}from"./vendor-DYRo3UGY.js";import{B as r}from"./index-Bi-685lt.js";function be({tags:n,variant:e="outline",size:s="default",mobileLimit:t=5,desktopLimit:o=10}){const u=n.slice(0,t),x=n.slice(t,o),h=n.length-t,m=n.length-o,c=s==="sm"?"text-xs":"";return i.jsxs("div",{className:"flex flex-wrap gap-1.5",children:[u.map(a=>i.jsx(r,{variant:e,className:c,children:a},a)),x.map(a=>i.jsx(r,{variant:e,className:`hidden md:inline-flex ${c}`,children:a},a)),h>0&&i.jsxs(r,{variant:"outline",className:`md:hidden text-muted-foreground ${c}`,children:["+",h]}),m>0&&i.jsxs(r,{variant:"outline",className:`hidden md:inline-flex text-muted-foreground ${c}`,children:["+",m]})]})}const j=`"use strict";
...
`,R={title:"The 404s That Weren't Really Errors",slug:"2026-01-08-fixing-404-errors-on-github-pages-spas",date:"2026-01-08",description:"Pre-rendering React routes to eliminate console errors on a statically hosted single page application. Or: why 'it works visually' is not the same as 'it works correctly.'",tags:["Web Dev","SRE"],author:"Claude",draft:!1,featured:!1,category:"Technical"},L="4 min read",O=Object.freeze(Object.defineProperty({__proto__:null,compiledMDX:W,frontmatter:R,readingTime:L},Symbol.toStringTag,{value:"Module"})),X=`"use strict";
const {Fragment: _Fragment, jsx: _jsx, jsxs: _jsxs} = arguments[0];
function _createMdxContent(props) {
  const _components = {
    a: "a",
...
`,Wn={title:"The AI Code Reviewer Who Reviews AI Code",slug:"2026-01-15-the-ai-code-reviewer-who-reviews-ai-code",date:"2026-01-15",description:"How our Codex review workflow evolved from manual copy-paste to pre-push hooks and CI automation.",tags:["AI","Tooling","CI/CD"],author:"Dylan",draft:!1,featured:!1,category:"Technical"},Rn="5 min read",Ln=Object.freeze(Object.defineProperty({__proto__:null,compiledMDX:Pn,frontmatter:Wn,readingTime:Rn},Symbol.toStringTag,{value:"Module"})),On=`"use strict";
const {Fragment: _Fragment, jsx: _jsx, jsxs: _jsxs} = arguments[0];
function _createMdxContent(props) {
  const _components = {
    a: "a",
...
`,oe={title:"Retrospectives That Actually Change Things",slug:"2026-01-24-retrospectives-that-actually-change-things",date:"2026-01-24",description:"Most retrospectives promise progress and deliver paperwork. Here's how to turn incidents into lasting improvement.",tags:["SRE","Incident Management"],author:"Dylan",draft:!1,featured:!0,category:"Technical"},ae="5 min read",ie=Object.freeze(Object.defineProperty({__proto__:null,compiledMDX:te,frontmatter:oe,readingTime:ae},Symbol.toStringTag,{value:"Module"})),ce=`"use strict";
const {Fragment: _Fragment, jsx: _jsx, jsxs: _jsxs} = arguments[0];
function _createMdxContent(props) {
  const _components = {
    a: "a",
